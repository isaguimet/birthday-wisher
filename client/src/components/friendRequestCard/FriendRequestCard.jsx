...
const FriendRequestCard = (props) => {
    ...
    const handleAcceptClick = () => {
        ...
        axiosInstance.patch(`https://proxy1-08e6.onrender.com/users/pendingFriendRequests/accept`, null, {params: queryParams}).then((response) => {
            ...
            if (err8080.response) {
                ...
                axiosInstance.patch(`https://proxy2-no3f.onrender.com/users/pendingFriendRequests/accept`, null, {params: queryParams}).then((response) => {
                    const [updatedPending, updatedFriends] = response.data;
                    props.setLoadingForPendingFriends(false);
                    props.setDataForPendingFriends(updatedPending);
                    props.setDataForFriends(updatedFriends);
    ...
    const handleDeclineClick = () => {
        ...
        props.setLoadingForPendingFriends(true);
        axiosInstance.patch(`https://proxy1-08e6.onrender.com/users/pendingFriendRequests/decline`, null, {params: queryParams}).then((response) => {
                props.setLoadingForPendingFriends(false);
            ...
            if (err8080.response) {
                ...
                axiosInstance.patch(`https://proxy2-no3f.onrender.com/users/pendingFriendRequests/decline`, null, {params: queryParams}).then((response) => {
                    props.setLoadingForPendingFriends(false);
                    props.setDataForPendingFriends(response.data);
                    props.setErrorForPendingFriends(null);
                }).catch((err) => {
