...
const FriendBirthdayList = (props) => {
    ...
    useEffect(() => {
        ...
        axiosInstance.get(`https://proxy1-08e6.onrender.com/users/friendList/${props.loggedInUser}`).then((response) => {
            ...
            if (err8080.response) {
                ...
                axiosInstance.get(`https://proxy2-no3f.onrender.com/users/friendList/${props.loggedInUser}`).then((response) => {
                    props.setLoading(false);
                    props.setData(response.data);
                    props.setError(null);
                }).catch((err) => {
