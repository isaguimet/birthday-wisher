...
public class BoardController {
    ...
    public ResponseEntity<?> setBoardPublic(@PathVariable ObjectId id) {
        try {
            commService.forwardBoardPatch("https://%s.onrender.com/boards/forwarded/setPublic/" + id);
    ...
    public ResponseEntity<?> setBoardPrivate(@PathVariable ObjectId id) {
        try {
            commService.forwardBoardPatch("https://%s.onrender.com/boards/forwarded/setPrivate/" + id);
    ...
    public ResponseEntity<?> setBoardOpen(@PathVariable ObjectId id) {
        try {
            commService.forwardBoardPatch("https://%s.onrender.com/boards/forwarded/setOpen/" + id);
    ...
    public ResponseEntity<?> setBoardClosed(@PathVariable ObjectId id) {
        try {
            commService.forwardBoardPatch("https://%s.onrender.com/boards/forwarded/setClosed/" + id);
    ...
    public ResponseEntity<?> deleteBoard(@PathVariable ObjectId id) {
        try {
            commService.forwardDeleteReq("https://%s.onrender.com/boards/forwarded/" + id);
    ...
    public ResponseEntity<?> deleteMessage(@PathVariable ObjectId boardId, @PathVariable ObjectId msgId) {
        try {
            commService.forwardDeleteReq("https://%s.onrender.com/boards/forwarded/" + boardId + "/messages/" + msgId);
