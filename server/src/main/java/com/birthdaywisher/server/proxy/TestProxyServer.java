package com.birthdaywisher.server.proxy;
...
public class TestProxyServer {
    ...
    /**
     * Run a single-threaded proxy server on the provided local port.
     */
    public static void runServer(String host, int remoteport, int localport)
        ...
        while (true) {
            ...
            try {
                ...
                // If unable to the server, send an error to the client, disconnect, and
                // continue waiting for connections.
                // To Do: Detect if server has gone down and listen for new requests for port of
                // new server leader
                try {
